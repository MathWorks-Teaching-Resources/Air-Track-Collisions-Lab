...
Download or clone this repository. Open MATLAB, navigate to the folder containing these scripts and double-click on  **Air_Track_Lab.prj**. It will add the appropriate files to your MATLAB path and open an app that asks you where you would like to start. 
...
|  | **In this script, students will...** |
| :-- | :-- |
| <img src="Images/image_9.png" width="171" alt="image_9.png"> | -  Compute momentum and energy from experimental observations. <br>-  Assess conservation of momentum. <br>-  Assess conservation of energy.  |
